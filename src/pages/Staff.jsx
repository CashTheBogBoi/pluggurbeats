    ...
    <div id="staff-root">
      <main>
        ...
        <div className="seg" style={{ marginBottom: "18px" }}>
          ...
          <button className={view === "users" ? "active" : ""} onClick={() => switchView("users")}>Users <span className="count">{users.length || ""}</span></button>
          <button className={view === "loops" ? "active" : ""} onClick={() => switchView("loops")}>Loop Claims <span className="count">{claims.length || ""}</span></button>
        </div>
