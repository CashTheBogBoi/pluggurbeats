...
// Sends a branded account-verification email via Resend.
// Called by the client right after createUserWithEmailAndPassword (user is signed in).
exports.sendVerificationEmail = onCall(
  ...
  async (request) => {
    ...
    const actionCodeSettings = { url: "https://pluggurbeats.com/", handleCodeInApp: false };
    let link;
    try {
    ...
    const sent = await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0e0e0e;color:#e8e0d0;padding:40px 32px;border:1px solid #262626">
          ...
          <p style="font-size:12px;color:#4d4635;line-height:1.6;margin:0 0 8px">Or copy and paste this link into your browser:</p>
          ...
          <div style="border-top:1px solid #262626;padding-top:20px">
            <p style="font-size:11px;color:#4d4635;margin:0">
              This link expires in 24 hours. If you didn't create a PluggurBeats account, you can safely ignore this email.
            </p>
          </div>
        </div>`,
    });
